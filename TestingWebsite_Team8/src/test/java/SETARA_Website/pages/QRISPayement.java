...
public class QRISPayement extends PageObject {
    ...
    private By infoQRMenu(){
        return By.xpath("//*[@id='root']/main/div/div[2]/div[1]/div/div[2]/div[4]/img");
    }
    ...
    public void openQRISPaymentPage() {
        wait.until(ExpectedConditions.visibilityOfElementLocated(infoQRMenu()));
        driver.findElement(infoQRMenu()).click();
